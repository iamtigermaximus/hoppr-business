...
// // Convert data to format expected by child components
// // Convert data to format expected by child components
...
//   timeRange: TimeRange,
// ) => {
//   // Use real growth data if available, otherwise fall back to calculated
//   const platformGrowth =
//     growthData && growthData.labels && growthData.labels.length > 0
//       ? {
...
//       // Fetch both summary and platform growth data in parallel
//       const [summaryResponse, growthResponse] = await Promise.all([
...
//         } else {
//           throw new Error(
//             summaryResult.error || "Failed to fetch summary data",
//           );
//         }
//       } else {
...
//           console.log("Growth data loaded:", growthResult.data);
//         }
//       } else {
//         console.log("Growth data not available, using fallback");
//       }
//     } catch (err) {
//       const errorMessage =
//         err instanceof Error ? err.message : "An unexpected error occurred";
...
//           <div>Loading analytics data...</div>
//           <div style={{ fontSize: "0.875rem", color: "#9ca3af" }}>
//             Fetching your platform statistics
//           </div>
//         </LoadingState>
//       </Container>
//     );
...
//   const analyticsData = convertToAnalyticsData(stats, growthData, timeRange);
